...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__net_remote__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Map__ = __webpack_require__(17);
 ...
 * @returns {Number}
 */
const approach = (goal, current, step) => {
...
/* harmony export (immutable) */ __webpack_exports__["b"] = approach;
...
const distanceTo = (p1, offsetX, offsetY, p2) =>
    Math.hypot(p1[0] + offsetX - p2[0], p1[1] + offsetY - p2[1])

const side = (p1, p2) => {
    const cos = [{
        dir: v100, // +0.5 +0
        distance: distanceTo(p1, 0.5, 0, p2)
    }, {
        dir: v100, // -0.5 +0
        distance: distanceTo(p1, -0.5, 0, p2)
    }, {
        dir: v010, // +0 +0.5
        distance: distanceTo(p1, 0, 0.5, p2)
    }, {
        dir: v010, // +0 -0.5
        distance: distanceTo(p1, 0, -0.5, p2)
    }]

    const min = cos.reduce((min, x) => x.distance < min.distance ? x : min, { distance: 10000 })

    return min.dir
}
/* harmony export (immutable) */ __webpack_exports__["c"] = side;


const inRange = (value, min, max) => 
    value > min && value < max
/* unused harmony export inRange */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__gl_Color__ = __webpack_require__(7);
...
class Style {
    constructor(style) {
        ...
        this.sides = {
            fill,
            fillLight: __WEBPACK_IMPORTED_MODULE_0__gl_Color__["a" /* default */].avg(fill, this.top.fill).mul(220 / 255),
...
class Plane {
    ...
    intersect(sphere) {
        ...
        const distance = this.norm.dot(v)

        return [Math.abs(distance) - sphere.r, Math.sign(distance)]
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__math_Util__ = __webpack_require__(4);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Shader__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Attribute__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Uniform__ = __webpack_require__(24);
...
class Program {
    ...
    constructor(gl, ...shaders) {
        ...
        for (let i = 0; i < shaders.length; i++) { // creating and attaching shaders
            if (typeof shaders[i] === 'string') shaders[i] = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__Shader__["a" /* createShader */])(gl, shaders[i])
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__math_Mat4__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__math_Util__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__entities_Player__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__gl_programs_basic_Program__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__gl_programs_pixelize_Program__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__objects_Flat__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__objects_Slide__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__objects_Arrow__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__entities_Diamond__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__gl_Color__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__objects_Water__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__entities_Button__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__entities_Elevator__ = __webpack_require__(20);
...
class Map {
            ...
            for (var i = 0; i < group.elements.length; i++) {
                ...
                switch (type.toLowerCase()) {
                    ...
                    case 'water':
                        ...
                        continue
                    case 'button':
                        var block = new __WEBPACK_IMPORTED_MODULE_7__entities_Button__["a" /* default */](...args)
                        this.entities.push(block)
                        this.IDs[args[1]] = block
                        continue
                    case 'elevator':
                        var block = new __WEBPACK_IMPORTED_MODULE_8__entities_Elevator__["a" /* default */](...args)
                        this.entities.push(block)
    ...
    update(game, dt) {
        for (var i = 0; i < this.entities.length; i++) {
            this.entities[i].update(game, dt, this)
        }
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__physics_coliders_Sphere__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Settings__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__math_Util__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__physics_const__ = __webpack_require__(11);
...
class Button {
    constructor(position) {
        ...
        this.drawPosition = new __WEBPACK_IMPORTED_MODULE_1__math_Vec3__["a" /* default */](-position[1] * s, -position[0] * s, -position[2])
        this.position = new __WEBPACK_IMPORTED_MODULE_1__math_Vec3__["a" /* default */](-position[1], -position[0], -position[2])

        var temp = []
        var temp2 = []
        for (var i = 0; i < 360; i += 2) {
            var val = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__math_Util__["a" /* degToRad */])(i * 2)
            temp.push(Math.sin(val) * 0.4, Math.cos(val) * 0.4, 0)
            temp2.push(Math.sin(val) * 0.4, Math.cos(val) * 0.4, 0)
            temp.push(Math.sin(val) * 0.3, Math.cos(val) * 0.3, 0)
            temp2.push(0, 0, 0)
        }
        this.top = new Float32Array(temp)
        this.topFill = new Float32Array(temp2)
        this.active = false
    }

    draw(bp, gl, styleg) {

        bp.position.set(this.drawPosition)
        bp.vert.set(this.topFill)
        bp.color.set(styleg[0].style.sides.fill)
        gl.drawArrays(gl.TRIANGLE_STRIP, 0, this.topFill.length / 3)
        bp.vert.set(this.top)
        bp.color.set(styleg[0].style.top.stroke)
        gl.drawArrays(gl.TRIANGLE_STRIP, 0, this.top.length / 3)

    }

    update(game, dt) {
        if (game.player.sphere.p.distanceTo(this.position) < 0.6) {
            this.active = true
        }
    }
}
...
class Player {
    ...
    draw(bp, gl, style) {
        ...
        for (let i = 0; i < 8; i++) {
            ...
            bp.color.set(__WEBPACK_IMPORTED_MODULE_5__gl_Color__["a" /* default */].random())
    ...
    update(game, dt) {
        if (
            ...
            this.collected = true
            __WEBPACK_IMPORTED_MODULE_6__Resources__["b" /* default */].sounds.diamond.play()
        }
    }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__math_Vec3__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__physics_coliders_Plane__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Settings__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__math_Util__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Resources__ = __webpack_require__(2);
...
class Elevator {
    constructor(position, top1, top2, activator) {

        this.position = new __WEBPACK_IMPORTED_MODULE_0__math_Vec3__["a" /* default */](-position[1], -position[0], -top1)
        ...
        var temp2 = []
        for (var i = 0; i < 360; i += 2) {
            var val = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__math_Util__["a" /* degToRad */])(i * 2)
            temp.push(Math.sin(val) * 0.6, Math.cos(val) * 0.6, 0)
            temp2.push(Math.sin(val) * 0.6, Math.cos(val) * 0.6, 0)
            temp.push(Math.sin(val) * 0.4, Math.cos(val) * 0.4, 0)
            temp2.push(0, 0, 0)
        }
        this.top = new Float32Array(temp)
        ...
        this.topPlane = new __WEBPACK_IMPORTED_MODULE_1__physics_coliders_Plane__["a" /* default */](
            new __WEBPACK_IMPORTED_MODULE_0__math_Vec3__["a" /* default */](0, 0, this.position[2]),
            new __WEBPACK_IMPORTED_MODULE_0__math_Vec3__["a" /* default */](1, 0, this.position[2]),
            new __WEBPACK_IMPORTED_MODULE_0__math_Vec3__["a" /* default */](1, 1, this.position[2])
        )
        this.done = true
    ...
    draw(bp, gl, styleg) {
        ...
        var pos = new __WEBPACK_IMPORTED_MODULE_0__math_Vec3__["a" /* default */](this.position[0] * s, this.position[1] * s, this.position[2])
    ...
    update(game, dt, map) {
        if (map.IDs[this.activator].active && this.done) { // detecting activation
            this.done = false
        }
        if (!this.done) { // update
            if (this.step == 0) {
                const val = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__math_Util__["b" /* approach */])(this.botY, this.position[2], 0.01)
                this.position[2] = val
                this.topPlane.p[2] = val
                if (val === this.botY)
                    this.step = 1
            } else if (this.step === 100) {
                const val = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__math_Util__["b" /* approach */])(this.topY, this.position[2], 0.01)
                this.position[2] = val
                this.topPlane.p[2] = val
                if (val === this.topY) {
                    this.done = true
                    map.IDs[this.activator].active = false
                    this.step = 0
                }
            } else {
                this.step++
...
/* harmony export (immutable) */ __webpack_exports__["a"] = Elevator;
...
class Player {
    constructor(position) {
        this.sphere = new __WEBPACK_IMPORTED_MODULE_3__physics_coliders_Sphere__["a" /* default */](new __WEBPACK_IMPORTED_MODULE_1__math_Vec3__["a" /* default */](-position[1], -position[0], -position[2]), 0.5)

        this.velocity = new __WEBPACK_IMPORTED_MODULE_1__math_Vec3__["a" /* default */](0, 0, 0)
        this.approachSpeed = 5
        this.createShapes()
    ...
    createShapes() {
        ...
        for (var i = 0; i < 4; i++) {
            temp[i] = [Math.cos(t) * 0.4, Math.sin(t) * 0.4, -1]
            t += Math.PI / 2
        }
        ...
        for (var i = 0; i < 4; i++) {
            temp[0] = [Math.cos(t) * 0.4, Math.sin(t) * 0.4, -1]
            t += Math.PI / 2
            temp[2] = [Math.cos(t) * 0.4, Math.sin(t) * 0.4, -1]
    ...
    update(blocks, dt, game) {
        ...
        for (var i = 0; i < blocks.elements.length; i++) {
            ...
            if (topData[1] > 0 && topData[0] < this.sphere.r) {
                ...
                this.sphere.p.add(v) // odwzorowanie przskoku do płaszczyzny w oryginale
                temp[0] = -blocks.elements[i].topPlane.norm[0] * 0.3
                temp[1] = -blocks.elements[i].topPlane.norm[1] * 0.3
                temp[2] = -__WEBPACK_IMPORTED_MODULE_6__physics_const__["a" /* Gravity */] - (temp[2] !== 0 ? 0.01 : 0)
            ...
            if (blocks.elements[i].position[2] <= this.sphere.p[2] &&
                ...
                const vel = __WEBPACK_IMPORTED_MODULE_1__math_Vec3__["a" /* default */].reflect(this.velocity, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__math_Util__["c" /* side */])(blocks.elements[i].position, this.sphere.p), 0.9)
                this.velocity = vel
            }
        ...
        if (this.move[0] === 0 && this.move[1] === 0) { // wydłużenie drogi chamowania
            this.approachSpeed = 7
        }

        this.velocity[0] =
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__math_Util__["b" /* approach */])(this.move[0] + temp[0], this.velocity[0], dt / this.approachSpeed)
        this.velocity[1] =
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__math_Util__["b" /* approach */])(this.move[1] + temp[1], this.velocity[1], dt / this.approachSpeed)

        this.velocity[2] = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__math_Util__["b" /* approach */])(__WEBPACK_IMPORTED_MODULE_6__physics_const__["a" /* Gravity */] + temp[2], this.velocity[2], dt / this.approachSpeed)
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__types_js__ = __webpack_require__(10);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Program__ = __webpack_require__(9);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Program__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vertex_glsl__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vertex_glsl___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__vertex_glsl__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fragment_glsl__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fragment_glsl___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__fragment_glsl__);
        ...
        switch (dir) {
            case 0:
                this.shape = new Float32Array([
                    0.5, 0.1, 0.0, 0.1, 0.5, 0.0, 0.9, 0.5, 0.0,
                    0.4, 0.5, 0.0, 0.4, 0.9, 0.0, 0.6, 0.9, 0.0,
                    0.6, 0.5, 0.0, 0.4, 0.5, 0.0, 0.6, 0.9, 0.0
                ])
                break
            case 1:
                this.shape = new Float32Array([
                    0.1, 0.5, 0.0, 0.5, 0.1, 0.0, 0.5, 0.9, 0.0,
                    0.5, 0.4, 0.0, 0.9, 0.4, 0.0, 0.9, 0.6, 0.0,
                    0.5, 0.6, 0.0, 0.5, 0.4, 0.0, 0.9, 0.6, 0.0
                ])
                break
            case 2:
                this.shape = new Float32Array([
                    0.5, 0.9, 0.0, 0.9, 0.5, 0.0, 0.1, 0.5, 0.0,
                    0.6, 0.5, 0.0, 0.6, 0.1, 0.0, 0.4, 0.1, 0.0,
                    0.4, 0.5, 0.0, 0.6, 0.5, 0.0, 0.4, 0.1, 0.0
                ])
                break
            case 3:
                this.shape = new Float32Array([
                    0.9, 0.5, 0.0, 0.5, 0.9, 0.0, 0.5, 0.1, 0.0,
                    0.5, 0.6, 0.0, 0.1, 0.6, 0.0, 0.1, 0.4, 0.0,
                    0.5, 0.4, 0.0, 0.5, 0.6, 0.0, 0.1, 0.4, 0.0
                ])
                break
        }
...
class Slide {
    ...
    constructor(position, height, heights) {
        ...
        this.topPlane = new __WEBPACK_IMPORTED_MODULE_1__physics_coliders_Plane__["a" /* default */](
            new __WEBPACK_IMPORTED_MODULE_2__math_Vec3__["a" /* default */](
                this.position[0] - 0.5,
                this.position[1] - 0.5,
                -height - heights[3] + this.position[2]
            ),
            new __WEBPACK_IMPORTED_MODULE_2__math_Vec3__["a" /* default */](
                this.position[0] + 0.5,
                this.position[1] - 0.5,
                -height - heights[0] + this.position[2]
            ),
            new __WEBPACK_IMPORTED_MODULE_2__math_Vec3__["a" /* default */](
                this.position[0] + 0.5,
                this.position[1] + 0.5,
                -height - heights[1] + this.position[2]
            )
        )

        this.sidePlanes = false
